...
import '../bloc/dialog_message_event.dart';

class DialogMessageBloc {
  String _message = 'message';
  Widget _widget;

  final _dialogMessageEventController =
      StreamController<DialogMessageEvent>.broadcast();
  ...
  StreamSink<Widget> get _inMessage => _dialogMessageStateController.sink;
  ...
  void _mapEventToState(DialogMessageEvent event) {
    if (event is UpdateDialogMessageEvent) _widget = Text(event.message);
