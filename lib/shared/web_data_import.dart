...
class ImportData {
  ...
  void getCompanyList(List<dynamic> i) async {
    int count = 1;
    for (var item in i) {
      _database.insert(CompanyTable.TABLE_NAME, {
      ...
      showMessage('Getting ${CompanyTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
    }
  }

  void getOutletList(List<dynamic> i) async {
    int count = 1;
    for(var item in i){
    _database.insert(OutletTable.TABLE_NAME, {
    ...
    showMessage('Getting ${OutletTable.TABLE_NAME} ... $count/${i.length} ');
    count++;
    }
  }
  ...
  void getUsersList(List<dynamic> i) {
    int count = 1;
    for(var item in i) {
      _database.insert(UserTable.TABLE_NAME, {
      ...
      showMessage('Getting ${UserTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
      }
    }
  ...
  void getVatAmountList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(VatAmountTable.TABLE_NAME, {
      ...
      showMessage('Getting ${VatAmountTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
    }
    }
  ...
  void getTablesList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(TablesTable.TABLE_NAME, {
      ...
      showMessage('Getting ${TablesTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
}
  }
  ...
  void getCategoriesList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(CategoryTable.TABLE_NAME, {
      ...
      showMessage('Getting ${CategoryTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
      }
  }
  ...
  void getModifiersList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(ModifierTable.TABLE_NAME, {
      ...
      showMessage('Getting ${ModifierTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
}
  }
  ...
  void getItemList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(ItemTable.TABLE_NAME, {
      ...
      showMessage('Getting ${ItemTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
      }
  ...
  void getItemModifiersList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(ItemModifierTable.TABLE_NAME, {
      ...
      showMessage('Getting ${ItemModifierTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
      }
  ...
  void getCustomersList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(CustomerTable.TABLE_NAME, {
        ...
        CustomerTable.DATE_OF_ANNIVERSARY: item[CustomerTable
            .DATE_OF_ANNIVERSARY],
        CustomerTable.IS_UPLOADED: item[CustomerTable.IS_UPLOADED],
      });
      showMessage('Getting ${CustomerTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
  ...
  void getPaymentMethodsList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(PaymentMethodTable.TABLE_NAME, {
      ...
      showMessage('Getting ${PaymentMethodTable.TABLE_NAME} ... $count/${i.length} ');
      count++;
      }
  ...
  void getExpenseCategoriesList(List<dynamic> i) {
    int count = 1;
    for(var item in i) {
      _database.insert(ExpenseCategoryTable.TABLE_NAME, {
        ...
        ExpenseCategoryTable.DESCRIPTION: item[ExpenseCategoryTable
            .DESCRIPTION],
  ...
  void getSalesList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(SalesMasterTable.TABLE_NAME, {
        ...
        SalesMasterTable.PAYMENT_METHOD_ID: item[SalesMasterTable.PAYMENT_METHOD_ID],
        SalesMasterTable.CLOSE_TIME: item[SalesMasterTable.CLOSE_TIME],
        SalesMasterTable.TABLE_ID: item[SalesMasterTable.TABLE_ID],
        SalesMasterTable.TOTAL_ITEM_DISCOUNT_AMOUNT: item[SalesMasterTable.TOTAL_ITEM_DISCOUNT_AMOUNT],
        SalesMasterTable.SUBTOTAL_WITH_DISCOUNT: item[SalesMasterTable.SUBTOTAL_WITH_DISCOUNT],
        SalesMasterTable.SUBTOTAL_DISCOUNT_AMOUNT: item[SalesMasterTable.SUBTOTAL_DISCOUNT_AMOUNT],
        SalesMasterTable.TOTAL_DISCOUNT_AMOUNT: item[SalesMasterTable.TOTAL_DISCOUNT_AMOUNT],
        SalesMasterTable.DELIVERY_CHARGE: item[SalesMasterTable.DELIVERY_CHARGE],
        SalesMasterTable.SUBTOTAL_DISCOUNT_VALUE: item[SalesMasterTable.SUBTOTAL_DISCOUNT_VALUE],
        SalesMasterTable.SUBTOTAL_DISCOUNT_TYPE: item[SalesMasterTable.SUBTOTAL_DISCOUNT_TYPE],
        ...
        SalesMasterTable.COOKING_START_TIME: item[SalesMasterTable.COOKING_START_TIME],
        SalesMasterTable.COOKING_DONE_TIME: item[SalesMasterTable.COOKING_DONE_TIME],
        ...
        SalesMasterTable.SALE_VAT_OBJECTS: item[SalesMasterTable.SALE_VAT_OBJECTS],
  ...
  void getSalesDetailsList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(SalesDetailTable.TABLE_NAME, {
        ...
        SalesDetailTable.MENU_PRICE_WITHOUT_DISCOUNT: item[SalesDetailTable.MENU_PRICE_WITHOUT_DISCOUNT],
        SalesDetailTable.MENU_PRICE_WITH_DISCOUNT: item[SalesDetailTable.MENU_PRICE_WITH_DISCOUNT],
        SalesDetailTable.MENU_UNIT_PRICE: item[SalesDetailTable.MENU_UNIT_PRICE],
        SalesDetailTable.MENU_VAT_PERCENTAGE: item[SalesDetailTable.MENU_VAT_PERCENTAGE],
        SalesDetailTable.MENU_TAXES: item[SalesDetailTable.MENU_TAXES],
        SalesDetailTable.MENU_DISCOUNT_VALUE: item[SalesDetailTable.MENU_DISCOUNT_VALUE],
        ...
        SalesDetailTable.DISCOUNT_AMOUNT: item[SalesDetailTable.DISCOUNT_AMOUNT],
        ...
        SalesDetailTable.COOKING_START_TIME: item[SalesDetailTable.COOKING_START_TIME],
        SalesDetailTable.COOKING_DONE_TIME: item[SalesDetailTable.COOKING_DONE_TIME],
        SalesDetailTable.PREVIOUS_ID: item[SalesDetailTable.PREVIOUS_ID],
        SalesDetailTable.SALES_MASTER_ID: item[SalesDetailTable.SALES_MASTER_ID],
  ...
  void getDeviceList(List<dynamic> i) {
    int count = 1;
    for(var item in i){
      _database.insert(DeviceTable.TABLE_NAME, {
  ...
  void showMessage(String text) {
    // Lib.dialogMessageUpdate(newMessage: text, bloc: bloc);
  }
