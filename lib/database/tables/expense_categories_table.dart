...
class ExpenseCategoryTable extends SqlCommons{
  ...
  static const String TABLE_NAME = 'expense_categories'; //8
  ...
  ExpenseCategoryTable(Database database, VerboseBloc bloc) : super(TABLE_NAME, COLUMN_NAMES, COLUMN_TYPES, database, bloc);
}