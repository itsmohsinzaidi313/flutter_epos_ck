...
class VatAmountTable extends SqlCommons{
  ...
  static const String TABLE_NAME = 'vat_amount'; //14
  ...
  VatAmountTable(Database database, VerboseBloc bloc) : super(TABLE_NAME, COLUMN_NAMES, COLUMN_TYPES, database, bloc);
